...
})();hljs.registerLanguage("json",e)})();/*! `ruby` grammar compiled for Highlight.js 11.5.1 */
...
illegal:"[^\\s\\}\\{]"}}})();hljs.registerLanguage("nginx",e)})();/*! `bash` grammar compiled for Highlight.js 11.5.1 */
